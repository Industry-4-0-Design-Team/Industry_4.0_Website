const Navbar = () => {
    return (
        <div className="w-full flex items-center py-8 pl-32 pr-32 text-primaryText bg-diamonds gap-52 font-medium tracking-wide text-sm">
            <div className="w-7/12 flex navbar-text justify-evenly gap-7 items-center">
                ...
                <button className="navbar-text hover:bg-[#FDE37F] hover:text-black transition-colors duration-300 px-4 py-2 rounded-md whitespace-nowrap flex-shrink-0">
                    ABOUT
                </button>
                <button className="navbar-text hover:bg-[#FDE37F] hover:text-black transition-colors duration-300 px-4 py-2 rounded-md whitespace-nowrap flex-shrink-0">
                    TEAM
