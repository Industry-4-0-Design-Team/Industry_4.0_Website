      ...
      <div className="relative z-10 flex justify-center items-center mx-[128px]">
        <div className="flex flex-col items-center custom-lg:flex-row">
          <div className="flex flex-col items-center justify-center ml-auto">
            ...
            {/* Subtitle Section */}
            <h2
              className="body text custom-lg:text-[24px] md:text-[20px] text-center mt-8 z-10 max-w-[550px] custom-lg:max-w-[850px]"
              data-aos="zoom-in"
              data-aos-offset="50"
              data-aos-delay="150"
          ...
          <div className="w-full text-center text-white my-16">
            <ul className="flex w-full text-center items-center justify-around gap-20">
              <li>
                <div data-aos="fade-up"
                    ...
                    data-aos-duration="700"
                    data-aos-once="true">
                  <h1 className="purpleNeonText font-black text-xl xs:text-3xl sm:text-4xl lg:text-6xl">1000+</h1>
              ...
              <li>
                <div data-aos="fade-up"
                    ...
                    data-aos-duration="700"
                    data-aos-once="true">
                  <h1 className="purpleNeonText font-black text-xl xs:text-3xl sm:text-4xl lg:text-6xl">60+</h1>
