      ...
      <div className="relative z-10 flex justify-center items-center mx-[12px] pt-48">
        <div className="flex flex-col custom-lg:flex-row">
          <img
            ...
            className="oscillate ml-[10rem] w-[320px] h-auto inline-block mt-24"
            draggable="false"
          />
          <div className="flex flex-col items-center custom-lg:items-end justify-center custom-lg:ml-auto mt-8 custom-lg:mt-0">
            <div className="flex items-center custom-lg:justify-end">
              <h1
                className="subtitle text-[24px] custom-lg:text-[54px]  sm:text-4xl
            ...
            <h2
              className="body custom-lg:text-[24px] md:text-[20px]
                            text-center custom-lg:text-right
                            text-xl
              ...
              data-aos-once="false"
            >
              At Industry 4.0, we strive to create a dynamic learning
              environment where students gain early access to industry-relevant
              skills, knowledge, and connections. Through mentorship,
              career-enhancing workshops, and a supportive community, we prepare
              students to excel in the tech-driven future and thrive in the
              evolving world of Industry 4.0.
            </h2>
          </div>
        </div>
      </div>
