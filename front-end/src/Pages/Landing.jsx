  ...
  return (
    <div id="landing" className="flex flex-col items-center w-full h-screen justify-center">
      ...
      <div className="flex flex-col items-center custom-lg:mt-[380px] mt-[250px]">
        ...
        <div className="flex items-center justify-center mt-32 md:mt-12 w-full">
          <h1 className="text-center text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-7xl custom-lg:text-8xl text-primaryText font-900">
            INDUSTRY 4.
            <img
        ...
        <div className="flex justify-center md:justify-end w-full mt-3 md:mt-6 lg:ml-[5rem] z-20">
          <div className="text-center md:text-right lg:text-right lg:mr-10">
            ...
            <div className="mt-6 flex flex-col items-center md:flex-row gap-5 md:justify-end">
              <button className="text-black font-800 bg-secondary px-4 py-1 rounded-full text-lg md:text-xl w-32 h-12 md:w-40 md:h-14 inline-flex items-center justify-center whitespace-nowrap transform transition-transform duration-200 hover:scale-110">
                  SIGN UP
              </button>
              <button className="buttonGlow text-secondary font-800 px-4 py-1 rounded-full text-sm md:text-lg w-32 h-12 md:w-40 md:h-14 transform transition-transform duration-200 hover:scale-110">
                SPONSORS
              </button>
            </div>
          </div>
